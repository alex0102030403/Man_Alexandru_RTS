...
public class Exercise2 {
	public static void main(String args[]) {
		...
		/*
		 * System.out.println("Read the first 3x3 matrix"); int[][] matrix1 = new
		 * int[3][3]; for (int i = 0; i < 3; i++){ for (int j = 0; j < 3; j++){
		 * matrix1[i][j] = scanner.nextInt(); } }
		 * 
		 * System.out.println("Read the second 3x3 matrix"); int[][] matrix2 = new
		 * int[3][3]; for (int i = 0; i < 3; i++){ for (int j = 0; j < 3; j++){
