...
public class Exercise1 {
	...
	public static void main(String args[]) {
		...
		case 1:
			...
			if (additionComplexPart < 0)
				System.out.println(
						"The addition of the 2 no results in: " + additionRealPart + additionComplexPart + "i");
			else
				System.out.println(
						"The addition of the 2 no results in: " + additionRealPart + "+" + additionComplexPart + "i");
		...
		case 2:
			...
			if (substractImgPart < 0)
				System.out
						.println("The addition of the 2 no results in: " + substractRealPart + substractImgPart + "i");
			else
				System.out.println(
						"The addition of the 2 no results in: " + substractRealPart + "+" + substractImgPart + "i");
		...
		case 3:
			...
			if (multiplyComplexPart < 0)
				System.out.println(
						"The addition of the 2 no results in: " + multiplyRealPart + multiplyComplexPart + "i");
			else
				System.out.println(
						"The addition of the 2 no results in: " + multiplyRealPart + "+" + multiplyComplexPart + "i");
