...
public class Fir extends Thread {
	...
	public Fir(ReentrantLock firstMonitor, ReentrantLock secondMonitor, int sleep_min, int sleep_max, int activity_min,
			int activity_max, CountDownLatch countDownLatch) {
